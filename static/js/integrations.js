...
>
    ...
    methods: {
        ...
        handleEdit(data) {
            console.debug('spotbugs editIntegration', data)
                ...
                response.json().then(
                    errorData => {
                        errorData.forEach(item => {
                            console.debug('spotbugs item error', item)
...
register_component('spotbugsIntegration', spotbugsIntegration)
